...
| `data-justify` | enum | `start`, `center`, `end` |  | Where each item settles along the track when data-snap is set: its start edge, its centre, or its end. Nothing without data-snap. |
